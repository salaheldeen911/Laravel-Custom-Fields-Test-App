    ...
    <div class="md:grid md:grid-cols-3 md:gap-8">
        <div class="md:col-span-1">
            <div class="px-4 sm:px-0 sticky top-24">
                <h3 class="text-2xl font-black text-gray-900 tracking-tight">Create New Post</h3>
                <p class="mt-2 text-sm text-gray-500 font-medium leading-relaxed">
                    Compose a new article. Custom fields are automatically loaded based on your configuration.
                </p>
                <div class="mt-6">
            ...
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="px-8 py-8 space-y-8">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="text" name="title" id="title" value="{{ old('title') }}" 
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-gray-50 focus:bg-white text-gray-900 font-bold placeholder-gray-400 text-lg" placeholder="Enter a catchy title...">
                            ...
                            <div>
                                ...
                                <textarea name="content" id="content" rows="6" 
                                    class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all bg-gray-50 focus:bg-white text-gray-900 font-medium placeholder-gray-400 resize-y" placeholder="Write your masterpiece here...">{{ old('content') }}</textarea>
                        ...
                        {{-- Custom Fields --}}
                        <x-custom-fields::render :model="null" :customFields="\App\Models\Post::customFields()" />
