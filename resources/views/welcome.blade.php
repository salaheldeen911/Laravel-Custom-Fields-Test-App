...
<div class="relative min-h-[80vh] flex flex-col justify-center overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <!-- Virtual Models Card -->
            {{-- <a href="{{ route('custom-fields.virtual-data.index') }}" class="group relative overflow-hidden bg-white rounded-3xl p-8 shadow-sm hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-pink-100 md:col-span-2 lg:col-span-2">
            <div class="absolute top-0 right-0 p-6 opacity-5 group-hover:opacity-10 transition-opacity">
                <svg class="w-32 h-32" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative z-10">
                <div class="w-14 h-14 bg-pink-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                    <svg class="w-7 h-7 text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                </div>
                <h3 class="text-2xl font-bold text-gray-900 group-hover:text-pink-600 transition-colors mb-3">Virtual Models (Headless)</h3>
                <p class="text-gray-500 leading-relaxed mb-6">
                    Define models on the fly without writing PHP classes or migrations. Perfect for dynamic forms, site settings, or user-defined schemas.
                </p>
                <div class="flex items-center text-sm font-bold text-pink-600">
                    Manage Virtual Data
                    <svg class="w-4 h-4 ml-1 transform group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path>
                    </svg>
